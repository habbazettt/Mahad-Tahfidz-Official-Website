    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row justify-center items-center gap-14 md:gap-40">
            <div className="flex flex-col gap-3">
                ...
                <p className="font-light" data-aos='fade-right' data-aos-duration='1500' data-aos-delay='300'>vestibulum morbi blandit cursus risus at ultrices mi tempus imperdiet nulla malesuada pellentesque elit eget gravida cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus mauris vitae</p>
                <p className="font-light" data-aos='fade-right' data-aos-duration='1500' data-aos-delay='300'>vestibulum morbi blandit cursus risus at ultrices mi tempus imperdiet nulla malesuada pellentesque elit eget gravida cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus mauris vitae</p>
